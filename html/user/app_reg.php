...
<div class="card-body">
    <div class="edit-profile__body">
        ...
        <div class="form-group mb-15">
            <div style="float:left;width:150px"><input type="text" class="form-control" id="code" placeholder="请输入验证码">
            </div>
            <div class="col-sm-4;width:40%;" style="float:right"><img
                        src="/kangml_app/mode/check_code.php?t=<?php echo time() ?>" class="ccode"
            ...
            $.post(
                'reg.php?act=reg_in', {
                    ...
                    if (data.status == "success") {
                        ...
                        $(".ccode").attr({"src": "/kangml_app/mode/check_code.php?t=" + Date.parse(new Date())});
                        alert(data.msg);
                    }
                }, "JSON"
            )
