        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="name" class="color-dark fs-14 fw-500 align-center">价格：<?= $tc_info["jg"] ?>元&nbsp;请输入数量(代理价格<?php echo($tc_info["jg"] * $admin_ext["per"] / 100) ?>
                            元 &nbsp;最多可购买：<?php echo $bn; ?>)</label>
    ...
    $(function () {
        $(".save").click(function () {
            ...
            $.post('?act=save', {
                ...
                if (data.status == "success") {
                    $('#setting').click();
                    window.location.href = "km_last.php";
                } else {
                    alert(data.msg);
                }
            }, "JSON");
