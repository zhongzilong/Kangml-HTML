...
/* line chart four - 流量版 */
function chartjsLineChartFourFlow(selector, bcolor = "#FA8B0C", height = "95", dataCur, dataPrev, labels) {
  var ctxs = document.getElementById(selector);
  if (ctxs) {
    ctxs.getContext("2d");
    ctxs.height = window.innerWidth <= 575 ? 190 : height;
        ...
        tooltips: {
          ...
          callbacks: {
            label(t, d) {
              ...
              return `<span class="chart-data">${yLabel}G</span> <span class="data-label">${d.datasets[datasetIndex].label}</span>`;
            },
          },
        },
        scales: {
